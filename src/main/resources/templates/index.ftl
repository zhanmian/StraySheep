...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-mini"><b>Bl</b>og</span>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="/AdminLTE/images/user3-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="/AdminLTE/images/user4-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="${baseUrl}/article/downloadImage?filePath=${adminUser.avatar!}"
                                 class="user-image" alt="User Image">
                            <span class="hidden-xs">${adminUser.nickName!}</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                ...
                                <p>
                                    ${adminUser.nickName!}
                                    <small>加入时间： ${adminUser.createTime!}</small>
                                </p>
                            </li>
                            <input type="hidden" id="user-id" value="${adminUser.userId!}"
            ...
            <ul class="sidebar-menu" data-widget="tree" id="sidebar-menu">
                ...
                <li class="active treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <@shiro.hasPermission name="read article">
                            <li><a href="javascript:;" data-url="article/to_list"><i class="fa fa-circle-o"></i>文章列表</a></li>
                        </@shiro.hasPermission>
                        <@shiro.hasPermission name="read user">
                            <li><a href="javascript:;" data-url="admin/to_admin_user_list"><i class="fa fa-circle-o"></i>用户管理</a></li>
                        </@shiro.hasPermission>
                        <@shiro.hasPermission name="read role">
                            <li><a href="javascript:;" data-url="admin/to_admin_role_list"><i class="fa fa-circle-o"></i>角色管理</a></li>
                        </@shiro.hasPermission>
                    </ul>
                </li>
    ...
    <div class="content-wrapper" id="content-wrapper">
        <div class="form-group col-xs-2 pull-left">
            <br>
            <label class="btn btn-primary fa fa-file-excel-o" for="export-excel">
                <button type="button" class="sr-only" id="export-excel"></button>
                <span>导出Excel</span>
            </label>
        </div>
        <div class="form-group col-xs-2 pull-left">
            <br>
            <label class="btn btn-primary fa fa-folder-open-o" for="inputFile">
                <input type="file" class="sr-only" id="inputFile" name="file">
                <span>选择文件</span>
            </label>
        </div>
        <div class="form-group col-xs-2 pull-left">
            <br>
            <label class="btn btn-primary fa " for="submit-excel">
                <button type="button" class="sr-only" id="submit-excel"></button>
                <span>导入Excel</span>
            </label>
        </div>
